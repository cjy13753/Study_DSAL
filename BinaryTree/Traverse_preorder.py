# pre-order (pre -> 부분 트리 순회 '전'에 현재 노드 출력)
# 순서 1: 현재 노드 데이터를 출력한다
# 순서 2: 재귀적으로 왼쪽 부분 트리 순회
# 순서 3: 재귀적으로 오른쪽 부분 트리 순회

# post-order (post -> 부분 트리 순회 '후'에 현재 노드 출력)
# 순서 1: 재귀적으로 왼쪽 부분 트리 순회
# 순서 2: 재귀적으로 오른쪽 부분 트리 순회
# 순서 3: 현재 노드 데이터를 출력한다

# in-order (in -> 부분 트리 순회 '사이에' 현재 노드 출력)
# 순서 1: 재귀적으로 왼쪽 부분 트리 순회 
# 순서 2: 현재 노드 데이터를 출력한다
# 순서 3: 재귀적으로 오른쪽 부분 트리 순회
